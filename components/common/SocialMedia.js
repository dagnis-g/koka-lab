          ...
          <div className="row footer-follow--header">
            <div className="px-3 footer-follow--title">
              ...
              <div className="d-flex">
                ...
                >
                  {/* <p className="mr-3">Doties uz</p> */}
                  <img className="ikona" src="/icon/facebook-brands.svg" alt="facebook" />
                ...
                >
                  {/* <p className="mr-3">Doties uz</p> */}
                  <img className="ikona" src="/icon/instagram-brands.svg" alt="facebook" />
                  {/* <img src="/icon/arrow-long-right.svg" alt="Arrow icon" /> */}
                </a>
                {/* </Link> */}
              </div>
